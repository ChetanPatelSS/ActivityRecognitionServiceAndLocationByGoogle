 ...
 * object.
 */
class DetectedActivitiesAdapter(
    context: Context?,
    detectedActivities: ArrayList<DetectedActivity>
) : ArrayAdapter<DetectedActivity>(
    context!!, 0, detectedActivities
) {
    override fun getView(position: Int, view: View?, parent: ViewGroup): View {
        ...
        // Find the UI widgets.
        val activityName = view!!.findViewById<View>(R.id.detected_activity_name) as TextView
        val activityConfidenceLevel = view.findViewById<View>(
            R.id.detected_activity_confidence_level
        ) as TextView
        val progressBar = view.findViewById<View>(
